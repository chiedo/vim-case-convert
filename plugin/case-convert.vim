...
command! -range=% -bang HyphenToCamelAll call CaseConvertFunc("HyphenToCamel", <bang>0,<line1>,<line2>)
command! -range=% -bang HyphenToSnakeAll call CaseConvertFunc("HyphenToSnake", <bang>0,<line1>,<line2>)
command! -range=% -bang SnakeToCamelAll call CaseConvertFunc("SnakeToCamel", <bang>0,<line1>,<line2>)
command! -range=% -bang SnakeToHyphenAll call CaseConvertFunc("SnakeToHyphen", <bang>0,<line1>,<line2>)
